...
export const skillNodes = [
  ...
  { id: 'derivatives', label: 'Derivatives', category: 'Calculus', dependsOn: ['slope'], x: 710, y: 70, keywords: ['derivative', 'instantaneous', 'gradient'] },
  ...
  { id: 'ai-training', label: 'AI Training', category: 'AI', dependsOn: ['functions', 'probability', 'derivatives', 'algorithms'], x: 840, y: 310, keywords: ['ai', 'model', 'loss', 'training'] },
