const subjectBlueprints = [
  {
    ...
    stages: [
      ['number-sense', 'Number Sense and Arithmetic', ['Place value systems', 'Fractions and ratios', 'Decimals and precision', 'Signed quantities', 'Estimation']],
      ...
      ['functions', 'Functions and Graphs', ['Input-output rules', 'Coordinate graphs', 'Linear models', 'Nonlinear patterns', 'Graph interpretation']],
      ...
      ['calculus', 'Calculus Foundations', ['Limits', 'Instantaneous rate', 'Derivative rules', 'Accumulation', 'Sensitivity']],
      ...
      ['linear-algebra', 'Linear Algebra', ['Vectors', 'Vector operations', 'Dot products', 'Matrices', 'Linear systems']],
  ...
  },
  {
    ...
    stages: [
      ...
      ['programming', 'Programming Fundamentals', ['Variables', 'Data types', 'Conditionals', 'Loops', 'Functions']],
